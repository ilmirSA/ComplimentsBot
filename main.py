...
def start(update, context):
    ...
    if check_username(user_name):
        ...
        text_three = 'Я не думал что мои слова ты воспринимаешь так близко к сердцу, поэтому качестве извинений я написал этого бота который делает тебе комплименты за меня. Надеюсь тебе понравиться 😜😝😎'
